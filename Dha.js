...
const groupMetadata = m.isGroup ? await Dha.groupMetadata(from).catch(e => {}) : ''
...
if (snya) return Dha.sendFile(m.chat, snya, "Quotly.webp", "", m)}
...
//antiviewonce
    if ( global.antiviewonce && m.mtype == 'viewOnceMessageV2') {
        ...
        await Dha.sendMessage(m.chat, { forward: val }, { quoted: fkontak })
...
await Dha.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://api.junn4.my.id/download/instagram?url=${budy}`)
Dha.sendMessage(m.chat, { video: { url: anu.result.media}, caption: `Auto Download ✅`}, {quoted: fkontak})
await Dha.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} else if (budy.match(`tiktok.com`)) {
await Dha.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://api.junn4.my.id/download/tiktok?url=${budy}`)
Dha.sendMessage(m.chat, { video: { url: anu.result.Medium.url}, caption: `Auto Download ✅`}, {quoted: fkontak})
await Dha.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} else if (budy.match(`facebook.com`)) {
await Dha.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://api.junn4.my.id/download/facebook?url=${budy}`)
Dha.sendMessage(m.chat, { video: { url: anu.result.video_sd}, caption: `Auto Download ✅`}, {quoted: fkontak})
await Dha.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} else if (budy.match(`youtube.com|youtu.be`)) {
await Dha.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://api.junn4.my.id/download/ytmp4?url=${budy}`)
Dha.sendMessage(m.chat, { video: { url: anu.result.result}, caption: ``}, {quoted: fkontak})
await Dha.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} 
} catch (err) {
await Dha.sendMessage(m.chat, { react: { text: "✖️",key: m.key,}})   
...
let uptime = clockString(_uptime)
            Dha.updateProfileStatus(`I am ${namasc} | Aktif Selama ${uptime}| Mode : ${Dha.public ? 'Public-Mode' : 'Self-Mode'} | User : ${pengguna.length}`).catch(_ => _)
        }
//===============//}
...
list.push({
	    	displayName: await Dha.getName(i),
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await Dha.getName(i)}\nFN:${await Dha.getName(i)}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:${ytname}\nitem2.X-ABLabel:YouTube\nitem3.URL:${socialm}\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;${location};;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
...
.on('finish', async () => {
await Dha.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
.on('finish', async () => {
await Dha.sendMessage(from, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
if (isAlreadyResponList((m.isGroup ? m.chat : botNumber), body.toLowerCase(), db_respon_list)) {
            ...
            if (get_data_respon.isImage === false) {
                Dha .sendMessage(m.chat, { text: sendResponList((m.isGroup ? m.chat : botNumber), body.toLowerCase(), db_respon_list) }, {
                    quoted: m
                })
            } else {
                Dha .sendMessage(m.chat, { image: await getBuffer(get_data_respon.image_url), caption: get_data_respon.response }, {
                    quoted: m
                })
            }
        }
...
if (isgclink) return Dha.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return Dha.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isOwner) return Dha.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
await Dha.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
Dha.ev.emit('messages.upsert', msg)
     ...
     const XeonStickWait = () => {
        ...
        Dha.sendMessage(from, { sticker: XeonStikRep }, { quoted: fkontak })
        }
...
async function sendGeekzMessage(chatId, message, options = {}){
    ...
    return await Dha.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}

const sendapk = (teks) => {
Dha.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:fkontak})
...
//=================================================//
const sendzip = (teks) => {
Dha.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:fkontak})
...
//=================================================//
const senddocu = (teks) => {
Dha.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted:fkontak})
...
const sendvn = (teks) => {
Dha.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, {quoted:fkontak})
}
...
try {
ppuser = await Dha.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
Dha.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
...
Dha.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
Dha.sendText(from, `Suit telah dikirimkan ke chat
...
if (!roof.pilih && !roof.pilih2) Dha.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
Dha.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
case'stalkwa':{
  ...
  if (!(await Dha.onWhatsApp(num))[0]?.exists) return m.reply('User not exists');
  let img = await Dha.profilePictureUrl(num, 'image').catch(_ => 'https://cdn.jsdelivr.net/gh/SazumiVicky/MakeMeow-Storage@main/avatar_contact.png');
  let bio = await Dha.fetchStatus(num).catch(_ => {});
  let name = await Dha.getName(num);
  let business = await Dha.getBusinessProfile(num);
...
case'telestick':{
  if (args[0] && args[0].match(/(https:\/\/t.me\/addstickers\/)/gi)) {
    ...
    if (m.isGroup && res.length > 30) {
      ...
      let encmedia = await Dha.sendImageAsSticker(m.sender, res[i].url, m, { packname: packname, author: author})
      await fs.unlinkSync(encmedia)
      }
    } else {
      for (let i = 0; i < res.length; i++) {
      let encmedia = await Dha.sendImageAsSticker(m.chat, res[i].url, m, { packname: packname, author: author });
      await fs.unlinkSync(encmedia)
      }
    }
...
case "confess": case 'menfes': case 'menfess': case "confes": {
                ...
                await Dha.sendMessage(nomorNya + '@s.whatsapp.net', { image: tod, caption: yoi }, {})
                ...
                await Dha.sendMessage(other, { text: `_@${m.sender.split("@")[0]} telah menerima menfess kamu, sekarang kamu bisa chat lewat bot ini_\n\n*NOTE :*\nJika ingin berhenti dari menfess, silahkan ketik .stop`, mentions: [m.sender] })
                Dha.sendMessage(m.chat, { text: `_Menfess telah diterima, sekarang kamu bisa chatan lewat bot ini_\n\n*NOTE :*\nJika ingin berhenti dari menfess, silahkan ketik .stop` })
            }
                break
                case 'tolak': {
                roof = Object.values(this.menfes).find(menpes => [menpes.a, menpes.b].includes(m.sender))
                ...
                let other = [room.a, room.b].find(user => user !== m.sender)
                find = Object.values(this.menfes).find(menpes => menpes.state == 'WAITING')
                Dha.sendMessage(other, { text: `_Uppsss... @${m.sender.split("@")[0]} Menolak menfess kamu_`, mentions: [m.sender] })
                ...
                Dha.sendMessage(to, { text: `_Teman chat telah menghentikan menfess ini_`, mentions: [m.sender] })
                await reply("Ok")
...
case 'group':
            case 'grup': {
                ...
                if (args[0] === 'close') {
                    await Dha.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`*Successfully Closed The Group*`)).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'open') {
                    await Dha.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`*Successfully Opened The Group*`)).catch((err) => reply(jsonformat(err)))
                } else {
...
let who
	...
	let url = await Dha .profilePictureUrl(who, "image");
	await Dha .sendFile(
		m.chat,
		url,
		"profile.jpg",
...
const getfunc = (funcc) => {
return "const "+`'${funcc}'`+fs.readFileSync('./Dha.js').toString().split('const \''+funcc+'\'')[1].split('')
}
 m.reply(`${getfunc(q)}`)
break      
case 'getcase':
...
case 'cekasalmember': {
 ...
 const participants = await Dha.groupMetadata(m.chat).then(metadata => metadata.participants);
...
Dha.sendMessage(from, { image: data, caption: `Sukses Kak` }, { quoted: kalgans })
}
break
case "detectqr": {
if (!quoted) return reply('*Khusus Pemilik!*')
...
let cmiggc = await Dha.groupMetadata(m.chat)
...
Dha.sendMessage(m.chat, {contacts: snContact}, {ephemeralExpiration: 86400})
break
case "savecontactid": {
if (!isOwner) return reply(`Khusus Owner`)
...
const groupMetadataa = !isGroup? await Dha.groupMetadata(`${text}`).catch(e => {}) : ""
...
Dha.sendMessage(from, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "Sukses Tinggal Save Ya Kakak", mimetype: "text/vcard", }, { quoted: m })
...
reply("_Wᴀɪᴛɪɴɢ ɪɴ ᴘʀᴏɢʀᴇss !!_")
const groupMetadata = isGroup? await Dha.groupMetadata(from).catch(e => {}) : ""
...
await Dha.sendMessage(sender, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: "Sukses Tinggal Save Ya Kakak", mimetype: "text/vcard", }, { quoted: m })
contacts.splice(0, contacts.length)
fs.writeFileSync("./database/contacts.json", JSON.stringify(contacts))
}
}
...
reply("wait")
const groupMetadataa = !isGroup? await Dha.groupMetadata(`${q.split("|")[0]}`).catch(e => {}) : ""
const participantss = !isGroup? await groupMetadataa.participants : ""
const halls = await participantss.filter(v => v.id.endsWith('.net')).map(v => v.id)
global.tekspushkonv3 = q.split("|")[2]
for (let mem of halls) {
if (/image/.test(mime)) {
media = await Dha.downloadAndSaveMediaMessage(quoted)
memk = await uptotelegra(media)
await Dha.sendMessage(men, { image: { url: mem }, caption: global.tekspushkonv3 })
await sleep(q.split("|")[1])
} else {
await Dha.sendMessage(mem, { text: global.tekspushkonv3 })
await sleep(q.split("|")[1])
}
}
reply("Succes✅")
...
await Dha.sendMessage(men, { image: { url: mem }, caption: global.tekspushkonv4 })
await sleep(text.split("|")[0])
} else {
await Dha.sendMessage(men, { text: global.tekspushkonv4 })
await sleep(text.split("|")[0])
}
}
reply("Succes✅")
...
media = await Dha.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(media)
await Dha.sendMessage(men, { image: { url: mem }, caption: global.tekspushkonv2 })
await sleep(5000)
} else {
await Dha.sendMessage(men, { text: global.tekspushkonv2 })
await sleep(5000)
}
}
...
await Dha.sendMessage(sender, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
contacts.splice(0, contacts.length)
fs.writeFileSync("./database/contacts.json", JSON.stringify(contacts))
}
}
...
reply(`wait`)
const groupMetadataa = !isGroup? await Dha.groupMetadata(`${text.split("|")[0]}`).catch(e => {}) : ""
const participants = !isGroup? await groupMetadataa.participants : ""
const halls = await participants.filter(v => v.id.endsWith('.net')).map(v => v.id)
...
media = await Dha.downloadAndSaveMediaMessage(quoted)
memk = await uptotelegra(media)
await Dha.sendMessage(mem, { image: { url: memk }, caption: global.tekspushkon })
await sleep(5000)
} else {
await Dha.sendMessage(mem, { text: global.tekspushkon })
await sleep(5000)
}
}
try {
...
await Dha.sendMessage(from, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
contacts.splice(0, contacts.length)
fs.writeFileSync("./database/contacts.json", JSON.stringify(contacts))
}
}
...
*❖ Link* : ${baby1[0].link}`
reply(`${result4}`)
Dha.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : fkontak })
}
break
//=================================================//
case 'addprem':
...
let ceknye = await Dha.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
teksooo += `\n*Total : ${owner.length}*`
Dha.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted:fkontak, contextInfo: { "mentionedJid": owner } })
break
//=================================================//
//=================================================//
        case 'addseller':
...
let cekbii = await Dha.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6282373608217`)
bnnd = q.split("|")[0].replace(/[^0-9]/g, '')
let ceknye1 = await Dha.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
//=================================================//
case "owner": {
const repf = await Dha.sendMessage(from, { 
contacts: { 
...
Dha.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner Ku Jangan Macam-macam Ya`, contextInfo:{
forwardingScore: 9999999, 
isForwarded: true,
mentionedJid:[sender]
}}, { quoted: repf })
} freya = fs.readFileSync('./freya/owner.mp3')
Dha.sendMessage(m.chat, {audio: freya, mimetype:'audio/mpeg', ptt:true, viewOnce: true }, {quoted:fkontak})
break
        case "backup":
        {
     ...
     await reply("Sabar Mas Lagi Backup!!!");
          ...
          await Dha.sendMessage(
            m.chat,
            {
              ...
              fileName: "Dha - BotzV1.zip",
            },
            { quoted:fkontak }
          );
          await execSync("rm -rf Dha - BotzV1.zip");
        }
        break
//=================================================//
...
await Dha.sendMessage(i, { image:media,  caption: txt,mentions:participants.map(a => a.id) })
}
if(/video/.test(mime)){
let media = await quoted.download()
await Dha.sendMessage(i, { video:media,  caption: txt, mentions:participants.map(a => a.id) })
}
            }
...
let response = await Dha.groupInviteCode(from)
Dha.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'resetlinkgc':
...
let response = await Dha.groupInviteCode(from)
Dha.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
...
await Dha.groupParticipantsUpdate(from, [users], 'remove')
}
break
//=================================================//
case 'add': {
...
await Dha.groupParticipantsUpdate(from, [users], 'add')
}
break
//=================================================//
case 'promote': {
...
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Dha.groupParticipantsUpdate(from, [users], 'promote')
}
break
//=================================================//
case 'demote': {
...
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Dha.groupParticipantsUpdate(from, [botNumber], 'demote')
}
break
//=================================================//
case 'hidetag': {
...
if (!m.isGroup) return reply('Buat Di Group Bodoh')
Dha.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted:fkontak})
}
break
//=================================================//
case 'ttp':
...
ini_txt = args.join(" ")
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=Dhagans&text=${ini_txt}`)
Dha.sendMessage(from, { sticker : ini_buffer }, { quoted:fkontak })
break
//=================================================
case 'editgroup': {   
if (!isOwner) return reply('*khusus Premium*')
...
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
if (args[0] === 'close'){
await Dha.groupSettingUpdate(from, 'announcement').then((res) => reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await Dha.groupSettingUpdate(from, 'not_announcement').then((res) => reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
Dha.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Group Open
...
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
 if (args[0] === 'open'){
await Dha.groupSettingUpdate(from, 'unlocked').then((res) => reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await Dha.groupSettingUpdate(from, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else {
 Dha.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Editinfo Open
...
await Dha.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editsubjek': {
...
await Dha.groupUpdateSubject(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
    case 'delgc':
...
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
if (!text) throw 'Text Nya ?'
await Dha.groupUpdateDescription(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'tagall': {
...
Dha.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted:fkontak })
}
break
//=================================================//
case'demoteall':
...
if (!isBotAdmins) return reply('Bot Bukan Admin Cuy')
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
var groupe = await Dha.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
})
Dha.groupParticipantsUpdate(from, mems, 'demote')
break
//=================================================//
case'promoteall':
if (!isOwner) return reply('*Khusus Premium*')
...
Dha.groupParticipantsUpdate(from, mems, 'promote')
break
//=================================================//
case 'tutorial': {
...
Dha.sendMessage(m.chat, { text: `「 *Create Group Sewa* 」
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await Dha.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await Dha.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
©By ${botname}`
try {
pp = await Dha.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
Dha.sendFile(from, pp, "", m, { caption: tekse, mentions: await Dha.parseMention(tekse) })
...
Dha.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak})
} else if (args[0] === "off") {
...
for (let x of anu) {
let metadata2 = await Dha.groupMetadata(x)
...
huhuhs = await Dha.sendMessage(m.chat, {
...
let anu = groups.map((v) => v.id)
for (let xnxx of anu) {
let metadat72 = await Dha.groupMetadata(xnxx)
let participanh = await metadat72.participants
if (/image/.test(mime)) {
media = await Dha.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(media)
await Dha.sendMessage(xnxx, { image: { url: mem }, caption: text.split('|')[0], mentions: participanh.map(a => a.id) })
await sleep(text.split('|')[1])
} else {
await Dha.sendMessage(xnxx, { text: text.split('|')[0], mentions: participanh.map(a => a.id) })
await sleep(text.split('|')[1])
}}
reply("*SUCCESFUL✅*")
}
...
for (let i of anu) {
await sleep(1500)
Dha.sendMessage(i, {text: `${text}`}, {quoted:fkontak})
    }
...
Dha.sendMessage(from, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak})
} else if (args[0] === "off") {
...
case 'larangan': case 'peraturan': {
 if (!m.isGroup) return reply('Buat Di Group Bodoh')
Dha.sendMessage(from, { text : `Haii 👋 Aku Shekai Bot ʜᴡ ᴍᴏᴅꜱ ᴡᴀ
...
if (isAdmins) return Dha.sendMessage(m.chat, {text: `\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\nAdmin sudah Toxic, admin bebas Toxic apapun`})
if (isOwner) return Dha.sendMessage(m.chat, {text: `\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\Owner telah Toxic, owner bebas Toxic apa pun`})
await Dha.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
...
Dha.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted:fkontak })
}
break
case 'hdvid2': {
...
Dha.sendMessage(m.chat, { video: { url: rsult.data.url }, caption: 'done' }, { quoted: m })
}
break
case'vidhd':
case'hdvid': {
  ...
  const who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? Dha.user.jid : m.sender;
  const name = await Dha.getName(who);
  const q = m.quoted ? m.quoted : m;
  const mime = (q.msg || q).mimetype || '';
  if (!mime) return reply(`Video nya mana kak??`);
 
reply('Tunggu Sebentar...');
  const media = await Dha.downloadAndSaveMediaMessage(q);
  ...
  exec(`ffmpeg -i ${media} -s 1280x720 -c:v libx264 -c:a copy ${output}`, (error, stdout, stderr) => {
    ...
    Dha.sendMessage(m.chat, { caption: `_Sukses Membuat Video Menjadi HD_`, video: { url: output }}, {quoted:fkontak});
  });
...
await Dha.sendMessage(m.chat, {image: {url: data.url.result}, caption: `Here u go!`}, {quoted: fkontak})
}
break
 case 'toanime': {
...
Dha.sendMessage(m.chat, { image: { url: `https://api.kiicodeit.me/ai/toanime?url=${anu}&apikey=KC-euHoZ2JgkOhs` }, caption: 'done' }, { quoted: fkontak })
}
break
case'tozombie':{
if (!quoted) return reply(`Send/Reply Image With Caption ${prefix + command}`)
...
let data = await anu.json()
await Dha.sendMessage(m.chat, {image: {url: data.url}, caption: `Here u go!`}, {quoted: fkontak})
}
break
case 'remini': {
			...
			Dha.sendMessage(m.chat, { image: proses, caption: `${muzan}Sukses kak ${pushname}${muzan}`}, { quoted:fkontak})
			}
			break
			case 'play':{
if (!text) return reply(`Example : ${prefix + command} Lagu sad`)
               let yts = require("youtube-yts")
let wait = await Dha.sendMessage(m.chat, {text: `_Searching.. [ ${text} ] 🔍_`}, {quoted: fkontak, ephemeralExpiration: m.expiration})
let search = await yts(`${text}`)
...
let mp3file = `./.npm/${search.all[0].views}.mp3`
  ...
  .pipe(fs.createWriteStream(mp3file))
  .on('finish', async () => {
await Dha.sendMessage(m.chat, {text: `_Mengirim.. [ ${text} ] 🔍_`, edit: wait.key }, {quoted:fkontak, ephemeralExpiration: m.expiration});
Dha.sendMessage(m.chat, {audio: fs.readFileSync(mp3file), mimetype: 'audio/mpeg',ptt:true, contextInfo: {externalAdReply: {title: `${search.all[0].title}`, body: `Views : ${search.all[0].views}`, thumbnailUrl: res12?.thumbnail, mediaType: 2, mediaUrl: `${search.videos[0].url}`, sourceUrl: `${search.videos[0].url}`, renderLargerThumbnail: true }}},{quoted:fvrif})
   })
...
Dha.sendMessage(m.chat, {react: {text: '🎧', key: m.key}})
break
//=================================================
...
await Dha.sendMessage(m.chat, { video: { url: anu.result.result}, caption: `💬Judul : ${nick}\n👤Channel : ${cpt}`}, {quoted: m})
await Dha.sendMessage(m.chat, { react: { text: `✅`, key: m.key } });
}catch (error) {
m.reply('Error') 
}
}
...
await sleep(1500)
await Dha.sendMessage(ban, { image: { url: slide}, caption: ``}, {quoted: m})
}
return Dha.sendMessage(m.chat, { react: { text: `✅`, key: m.key } });
}catch (error) {
...
await Dha.sendMessage(m.chat, { video: { url: anu.result.Medium.url}, caption: `*Downloaded Successfully*\n\n© > TIKTOK DOWNLOAD BY Dha`}, {quoted: m})
await Dha.sendMessage(m.chat, {audio : {url : aud}, mimetype:'audio/mpeg'}, {quoted:m})
   await Dha.sendMessage(m.chat, { react: { text: `✅`, key: m.key } });
   }catch (error) {
     await Dha.sendMessage(m.chat, { react: { text: `❎`, key: m.key } });
   }
...
Dha.sendMessage(m.chat, { caption: `Sukses, Ini Tuan Video Nya`, video: { url: data.nowm }}, {quoted:fkontak})
})
}
break      
...
case "ttdl": {
    ...
    try {
        ...
        if (videoURL || videoURLWatermark) {
            await Dha.sendMessage(m.chat, { video: { url: videoURL }, caption: `Ini kak videonya\n\n${infonya_gan}`}, {quoted:fkontak});
            setTimeout(async () => {
                await Dha.sendMessage(m.chat, { audio: { url: tiktokData.music.play_url }, caption: " ni musik nya" }, { quoted:fkontak })
            }, 5000);
        } else {
...
case  'ai2':
    ...
    Dha.sendMessage(m.chat, {text: result }, {quoted:fkontak})
    }
    break
case "sindy":{
...
*Url*: ${api.data[0].url}
`
Dha.sendMessage(m.chat, {text: hasil, contextInfo:
{
"externalAdReply": {
...
break
 case 'sethumb':
            case 'sim': {
                ...
                let delb = await Dha.downloadAndSaveMediaMessage(quoted)
...
Dha.groupParticipantsUpdate(m.chat, [x], "remove")
} else if (data.includes(groupOwner)) {
setTimeout(() => {
Dha.groupParticipantsUpdate(m.chat, [groupOwner], "remove")
}, 1) 
Dha.groupParticipantsUpdate(m.chat, [groupOwner], "demote")
}}}
break
case  'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
 ...
 Dha.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg', ptt: true }, { quoted:fkontak })
 fs.unlinkSync(ran)
 })
...
if (!text) return reply('Please provide a song name')
  try {
    ...
    if (json.thumbnail) {
      await Dha.sendMessage(m.chat, {image: {url:json.thumbnail}, caption: songInfo}, {quoted:fkontak})
    } else {
      reply(songInfo)
    }
  } catch (error) {
...
await Dha.sendPresenceUpdate('recording', m.chat);
...
case 'igvideo2': case 'igreels2':
			...
			axios.get(`https://api.lolhuman.xyz/api/instagram?apikey=${apikey}&url=${args[0]}`).then(({ data }) => {
				Dha.sendMessage(from, { video: { url: data.result }, mimetype: 'video/mp4', caption : `silahkan ketik tovn atau to audio untuk merubah nya menjadi audio / vn`})
			})
			break
   ...
   Dha.sendMessage(m.chat, { video: { url: anu.result.video_sd}, caption: `*Downloaded Successfully*\n\n© *FACEBOOK DOWNLOAD BY Dha*`}, {quoted: m})
   await Dha.sendMessage(m.chat, { react: { text: `✅`, key: m.key } });
   }catch (error) {
     await Dha.sendMessage(m.chat, { react: { text: `❎`, key: m.key } });
   }
    ...
    break
		case 'fbvideo':
			...
			axios.get(`https://api.lolhuman.xyz/api/twitter?apikey=${apikey}&url=${args[0]}`).then(({ data }) => {
				Dha.sendMessage(from, { video: { url: data.result.link[data.result.link.length - 1].link }, mimetype: 'video/mp4' })
			})
			break
//=================================================//
...
if (stiker) return Dha.sendFile(m.chat, stiker, 'Quotly.webp', '', m)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maksimal 10 detik!')
let media = await quoted.download()
let stiker = await sticker5(media, false, `${teks1}`, `${teks2}`)
...
if (/video/.test(mime)) {
let media = await quoted.download()
let encmedia = await Dha.sendVideoAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
Dha.sendImageAsSticker(from, result, m, { packname: global.packname, author: global.author })
}
break   
case 'dino': {    
let { pinterest } = require('./lib/scraperr')
...
Dha.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: fkontak })
}
break
//=================================================//
case 'gambar': {
...
Dha.sendMessage(from, {image: { url: result }, caption: 'SUKSES'},{quoted:fkontak})
}
break
//=================================================//
case 'fajar':
...
teks += ""
Dha.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted:fkontak })
})
break
//=================================================//
case 'tribun':
...
teks += `Source: ${reis}`
teks += ""
Dha.sendMessage(m.chat, { image : { url : reis }, caption: teks }, { quoted:fkontak })
break
//=================================================
case 'faktaunik':
case 'katabijak':
...
Dha.sendMessage(from, { audio: { url: `https://api.lolhuman.xyz/api/quran/audio/${args[0]}?apikey=${apikey}` }, mimetype: 'audio/mp4' })
break
//=================================================
case 'asmaulhusna':
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
Dha.sendImageAsSticker(m.chat, kaytid, m, { packname: global.packname, author: global.author })
}
break
//=================================================
...
Dha.sendMessage(from, { image: buffer }, {quoted:fkontak})
fs.unlinkSync(ran)
})
}
break
...
await Dha.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, {quoted:fkontak})
...
let media = await Dha.downloadMediaMessage(quoted)
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
Dha.sendMessage(m.chat, {document: audio.data, mimetype: 'audio/mpeg', fileName: `Convert By ${Dha.user.name}.mp3`}, { quoted:fkontak })
}
break
//=================================================//
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
Dha.sendMessage(m.chat, {audio: audio.data, mimetype: 'audio/mpeg'}, { quoted:fkontak })
}
break
//=================================================//
...
Dha.sendMessage(from, {audio: audio.data, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
...
let media = await Dha.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await Dha.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, {quoted:fkontak})
await fs.unlinkSync(media)
}
break
//=================================================//
...
teks = "*Darkjokes*"
Dha.sendMessage(m.chat, { image : { url : ress }, caption: teks }, { quoted:fkontak })
break
//=================================================//
case 'emojimix': { 
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
let encmedia = await Dha.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
let teks = `list cmd`
Dha.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'addpdf':{
...
let teks = `${text}`
{
Dha.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:fkontak})
}
}
break
//=================================================//
...
let teks = `${text}`
{
Dha.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:fkontak})
...
let teks = `${text}`
{
Dha.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:fkontak})
}
}
break
//=================================================//
...
let teks = `${text}`
{
Dha.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:fkontak})
...
let teks = `${text}`
{
Dha.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:fkontak})
}
}
break
//=================================================//
...
let teks = `${text}`
{
Dha.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:fkontak})
...
case 'list': case 'store': {
                ...
                let metadata = await Dha .groupMetadata(m.chat)
                ...
                Dha .sendMessage(m.chat, { text: teks, mentions: [m.sender] }, { quoted: m })
            }
                break
            case 'dellist': {
...
if (!isOwner) return reply('*Khusus Premium*')
 ...
 Dha.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 let msgs = global.db.data.database
 if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
 Dha.copyNForward(from, msgs[text.toLowerCase()], true)
}
break
//=================================================//
case 'google': {
...
Dha.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, {quoted:fkontak})
Dha.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, {quoted:fkontak})
}
break
//=================================================//
case 'coffe': case 'kopi': {

Dha.sendMessage(from, {image: { url: 'https://coffee.alexflipnote.dev/random' },
...
if (qtod === "true") {
namenye = await Dha.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
Dha.sendMessage(from, {text:"Reply orangnya"}, {quoted:fkontak})
}
}
break
//=================================================//
...
if (qtod === "true") {
try {
pporg = await Dha.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
Dha.sendMessage(from, { image : { url : pporg }, caption:`Done` }, {quoted:fkontak})
} else if (qtod === "false") {
try {
pporgs = await Dha.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
Dha.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, {quoted:fkontak})
}
}
break
...
var medis = await Dha.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (args[0] == `/full`) {
...
var memeg = await Dha.updateProfilePicture(botNumber, { url: medis })
fs.unlinkSync(medis)
reply(`Sukses`)
}
}
...
let media = await Dha.downloadAndSaveMediaMessage(m)
...
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Dha.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
...
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Dha.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'stalktiktok':
...
Dha.sendMessage(from, { image: { url: data.result.user_picture }, caption })
})
break
//=================================================//
...
Dha.sendMessage(from, { image: { url: data.result.map }, caption })
break
//=================================================
case 'lirik':
...
caption += `Story :\n${data.result.story}\n`
Dha.sendMessage(from, { image: { url: data.result.thumbnail }, caption })
break
//=================================================
case 'cuaca':
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
Dha.sendMessage(from, { location: { degreesLatitude: data.result.latitude, degreesLongitude: data.result.longitude } })
reply(textppp)
break
//=================================================
case 'afk': {
...
if (m.quoted && m.quoted.mtype === 'conversation' && !text) _m = Dha.sendMessage('status@broadcast', {
text: m.quoted.text,
}, {
...
if (!m.quoted && text) _m = Dha.sendMessage('status@broadcast', {
text,
}, {
backgroundColor: '#FF000000',
font: 3,
...
const media = await Dha.downloadAndSaveMediaMessage(quoted)
Dha.sendMessage('status@broadcast', { image: { url: media }}, {statusJidList: pengguna})
}
reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
const media = await Dha.downloadAndSaveMediaMessage(quoted)
Dha.sendMessage('status@broadcast', { video: { url: media }}, {statusJidList: pengguna})
}
reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
return reply(`Reply Status WhatsApp !`);
  let buffer = await m.quoted.download();
  await Dha.sendFile(m.chat, buffer, "", m.quoted.text || "", null, false, {quoted: fkontak,})
...
case 'upsw': 
        {
          ...
          if (/image/.test(mime)) {
            let imgSw = await Dha.downloadAndSaveMediaMessage(quoted);
            await Dha.sendMessage(
              "status@broadcast",
            ...
            let VidSw = await Dha.downloadAndSaveMediaMessage(quoted);
            await Dha.sendMessage(
              "status@broadcast",
            ...
            let VnSw = await Dha.downloadAndSaveMediaMessage(quoted);
            await Dha.sendMessage(
              "status@broadcast",
...
Dha.sendMessage('status@broadcast', {
text: `${text}`
}, {
backgroundColor: '#FF000000',
font: 3,
...
Dha.sendMessage('status@broadcast', {audio: huy, mimetype: 'audio/mp4', ptt:true},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
}
...
Dha.sendMessage('status@broadcast', {audio: buu, mimetype:'audio/mp4', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6282373608217',
title: `L1S MODS WA`,
sourceUrl: `https://wa.me/6282373608217`, 
...
Dha.sendMessage(from, { text: teksoooo.trim() }, 'extendedTextMessage', { quoted:fkontak, contextInfo: { "mentionedJid": pengguna } })
break
//=================================================
case "buatswptv":
{
...
Dha.relayMessage('status@broadcast', ptv.message, {
statusJidList: pengguna
})
}
reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
...
Dha.relayMessage(from, ptv.message, { messageId: ptv.key.id })
}
}
break
//=================================================//
...
if (!u) return
let d = (await Dha.onWhatsApp(u.split`@`[0]))[0] || {}
...
Dha.sendMessage(u,{image: {url: akunlo}, caption: ctf }, { quoted: fkontak })
...
10GB ✅
UNLI ✅`
Dha.sendMessage(from, {text : lrm}, {quoted:fkontak})
break 
        case "panel": {
...
▬▭▬▭▬▭▬▭▬▭▬▭▬`
Dha.sendMessage(from, { text: text12, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted:fkontak })
}
break
                case "listsrv": {
  ...
  await Dha.sendMessage(m.chat, { text: messageText }, { quoted:fkontak });
...
let user = data.attributes
let p = await Dha.sendMessage(m.chat, { text: `
...
Dha.sendMessage(u, { text: `*BERIKUT DETAIL AKUN PANEL ANDA*\n
╭─❏ *『 USER INFO 』*
┣❏ ➤ *📧EMAIL* : ${email}
┣❏ ➤ *👤USERNAME* : ${username}
┣❏ ➤ *🔐PASSWORD* : ${password.toString()}
...
`
    ...
    await Dha.sendMessage(m.chat, listMessage)

    await Dha.sendMessage(nomornya, {
...
if (!/webp/.test(mime)) throw `Balas sticker dengan caption *${prefix + command}*`
const media = await Dha.downloadAndSaveMediaMessage(quoted)
Dha.sendMessage('status@broadcast', { sticker: { url: media }}, {statusJidList: pengguna})
}
reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case 'family100': {
 ...
 id: 'family100'+from,
 pesan: await Dha.sendText(from, hasil, m),
 ...random,
...
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 let msg = await Dha.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, {quoted:fkontak})
 Dha.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
 tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
 })
 await sleep(12000)
 if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
 console.log("Jawaban: " + result.jawaban)
 Dha.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ea6aa75bf8c2f86f15d76.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:fkontak}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 Dha.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 Dha.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 Dha.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 Dha.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
...
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 Dha.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
this.suit[id] = {
chat: await Dha.sendText(from, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) Dha.sendText(from, `_Waktu suit habis_`, m)
delete this.suit[id]
...
Dha.relayMessage(from, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
}
}
break
 //=================================================
...
let ppnyauser = await await Dha.profilePictureUrl(m?.sender, 'image').catch(_=> 'https://telegra.ph/file/6880771a42bad09dd6087.jpg')
const rest = await quote(text, pushname, ppnyauser)
Dha.sendImageAsSticker(m?.chat, rest.result, m, { packname: `${global.packname}`, author: `${global.author}`})
}
break
case  'qcimg':{
if (isBan) return reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
...
const text = `${teks}`
const username = await Dha.getName(m.quoted ? m.quoted.sender : m.sender)
const avatar = await Dha.profilePictureUrl( m.quoted ? m.quoted.sender : m.sender,"image").catch(() =>`https://i0.wp.com/telegra.ph/file/134ccbbd0dfc434a910ab.png`)
...
Dha.sendMessage(from,{image: buffer},{quoted : hw})
})
}
break
//=================================================//
...
.then(async (res) => {
const buffer = Buffer.from(res.data.result.image, "base64");
let encmedia = await Dha.sendImageAsSticker(m.chat, buffer, m, { packname: global.packname, 
...
Dha.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
